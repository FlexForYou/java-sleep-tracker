...
public class MidSessionLength implements Function<List<SleepingSession>, SleepAnalysisResult> {
    ...
    public SleepAnalysisResult apply(List<SleepingSession> sessions) {
        ...
        double midDuration = sessions.stream()
                .mapToLong(SleepingSession::getDurationMinutes)
                .average()
                .orElse(0);


        return new SleepAnalysisResult("Средняя продолжительность сессии (в минутах)", midDuration);
    }
}
