...
public class SleeplessNights implements Function<List<SleepingSession>, SleepAnalysisResult> {
    ...
    public SleepAnalysisResult apply(List<SleepingSession> sessions) {
        ...
        long numberOfSleeplessNights = sessions.stream()
                .filter(SleepingSession::checkSleeplessNights)
                .count();

        return new SleepAnalysisResult("Количество бессонных ночей", numberOfSleeplessNights);
    }
